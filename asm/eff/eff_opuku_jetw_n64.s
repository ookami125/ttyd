...
/* 801D2278 001CF278  41 82 00 08 */	beq .L_801D2280
/* 801D227C 001CF27C  48 00 00 14 */	b .L_801D2290
.L_801D2280:
...
/* 801D228C 001CF28C  48 00 00 10 */	b .L_801D229C
.L_801D2290:
...
/* 801D22C0 001CF2C0  C0 02 E4 40 */	lfs f0, lbl_8041F7C0@sda21(r2)
...
/* 801D23E0 001CF3E0  C0 22 E4 44 */	lfs f1, lbl_8041F7C4@sda21(r2)
/* 801D23E4 001CF3E4  38 61 00 A0 */	addi r3, r1, 0xa0
/* 801D23E8 001CF3E8  C0 62 E4 48 */	lfs f3, lbl_8041F7C8@sda21(r2)
...
/* 801D240C 001CF40C  C0 22 E4 40 */	lfs f1, lbl_8041F7C0@sda21(r2)
...
/* 801D2430 001CF430  C0 62 E4 4C */	lfs f3, lbl_8041F7CC@sda21(r2)
...
/* 801D2458 001CF458  80 02 1E 48 */	lwz r0, lbl_804231C8@sda21(r2)
...
/* 801D2498 001CF498  41 81 00 80 */	bgt .L_801D2518
/* 801D249C 001CF49C  80 02 1E 4C */	lwz r0, lbl_804231CC@sda21(r2)
...
/* 801D2530 001CF530  48 00 02 28 */	b .L_801D2758
.L_801D2534:
...
/* 801D2548 001CF548  48 00 02 00 */	b .L_801D2748
.L_801D254C:
...
/* 801D2558 001CF558  41 81 01 E8 */	bgt .L_801D2740
...
/* 801D2568 001CF568  41 81 01 D8 */	bgt .L_801D2740
...
/* 801D2598 001CF598  C0 22 E4 50 */	lfs f1, lbl_8041F7D0@sda21(r2)
...
/* 801D25AC 001CF5AC  C0 62 E4 48 */	lfs f3, lbl_8041F7C8@sda21(r2)
...
/* 801D25FC 001CF5FC  C0 82 E4 54 */	lfs f4, lbl_8041F7D4@sda21(r2)
...
/* 801D260C 001CF60C  C0 62 E4 4C */	lfs f3, lbl_8041F7CC@sda21(r2)
...
/* 801D2644 001CF644  38 6D C9 70 */	addi r3, r13, lbl_80413BD0@sda21
...
/* 801D267C 001CF67C  C0 62 E4 40 */	lfs f3, lbl_8041F7C0@sda21(r2)
...
/* 801D26D4 001CF6D4  80 62 1E 50 */	lwz r3, lbl_804231D0@sda21(r2)
...
/* 801D274C 001CF74C  41 80 FE 00 */	blt .L_801D254C
...
/* 801D275C 001CF75C  41 80 FD D8 */	blt .L_801D2534
...
/* 801D27E4 001CF7E4  41 82 00 14 */	beq .L_801D27F8
...
/* 801D2800 001CF800  40 80 00 0C */	bge .L_801D280C
...
/* 801D2920 001CF920  41 81 00 10 */	bgt .L_801D2930
/* 801D2924 001CF924  38 00 03 E8 */	li r0, 0x3e8
/* 801D2928 001CF928  90 03 00 10 */	stw r0, 0x10(r3)
/* 801D292C 001CF92C  48 00 00 08 */	b .L_801D2934
.L_801D2930:
...
/* 801D2944 001CF944  C0 22 E4 48 */	lfs f1, lbl_8041F7C8@sda21(r2)
/* 801D2948 001CF948  D3 83 00 04 */	stfs f28, 4(r3)
/* 801D294C 001CF94C  C0 02 E4 4C */	lfs f0, lbl_8041F7CC@sda21(r2)
