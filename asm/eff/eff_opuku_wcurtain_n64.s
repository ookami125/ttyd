...
/* 801D3700 001D0700  80 02 1E 60 */	lwz r0, lbl_804231E0@sda21(r2)
...
/* 801D3724 001D0724  C0 22 E4 98 */	lfs f1, lbl_8041F818@sda21(r2)
...
/* 801D3834 001D0834  C0 22 E4 9C */	lfs f1, lbl_8041F81C@sda21(r2)
/* 801D3838 001D0838  38 61 00 48 */	addi r3, r1, 0x48
/* 801D383C 001D083C  C0 62 E4 A0 */	lfs f3, lbl_8041F820@sda21(r2)
...
/* 801D3880 001D0880  C0 42 E4 A4 */	lfs f2, lbl_8041F824@sda21(r2)
/* 801D3884 001D0884  C0 22 E4 A8 */	lfs f1, lbl_8041F828@sda21(r2)
...
/* 801D3938 001D0938  42 00 FF 60 */	bdnz .L_801D3898
...
/* 801D3980 001D0980  48 00 00 C4 */	b .L_801D3A44
.L_801D3984:
...
/* 801D3A48 001D0A48  41 80 FF 3C */	blt .L_801D3984
...
/* 801D3A84 001D0A84  48 00 00 40 */	b .L_801D3AC4
.L_801D3A88:
...
/* 801D3AC8 001D0AC8  41 80 FF C0 */	blt .L_801D3A88
...
/* 801D3B70 001D0B70  41 82 00 14 */	beq .L_801D3B84
...
/* 801D3B8C 001D0B8C  40 80 00 0C */	bge .L_801D3B98
...
/* 801D3BD4 001D0BD4  40 80 00 10 */	bge .L_801D3BE4
...
/* 801D3BEC 001D0BEC  C0 62 E4 AC */	lfs f3, lbl_8041F82C@sda21(r2)
/* 801D3BF0 001D0BF0  38 80 00 00 */	li r4, 0
/* 801D3BF4 001D0BF4  C0 42 E4 B0 */	lfs f2, lbl_8041F830@sda21(r2)
/* 801D3BF8 001D0BF8  C0 22 E4 98 */	lfs f1, lbl_8041F818@sda21(r2)
...
/* 801D3C24 001D0C24  40 81 00 10 */	ble .L_801D3C34
...
/* 801D3C58 001D0C58  40 81 00 10 */	ble .L_801D3C68
...
/* 801D3C8C 001D0C8C  40 81 00 10 */	ble .L_801D3C9C
...
/* 801D3CC0 001D0CC0  40 81 00 10 */	ble .L_801D3CD0
...
/* 801D3CD8 001D0CD8  42 00 FF 28 */	bdnz .L_801D3C00
...
/* 801D3DB4 001D0DB4  41 81 00 10 */	bgt .L_801D3DC4
/* 801D3DB8 001D0DB8  38 00 03 E8 */	li r0, 0x3e8
/* 801D3DBC 001D0DBC  90 03 00 10 */	stw r0, 0x10(r3)
/* 801D3DC0 001D0DC0  48 00 00 08 */	b .L_801D3DC8
.L_801D3DC4:
...
/* 801D3DE8 001D0DE8  C3 62 E4 A0 */	lfs f27, lbl_8041F820@sda21(r2)
...
/* 801D3E08 001D0E08  C3 A2 E4 B8 */	lfs f29, lbl_8041F838@sda21(r2)
/* 801D3E0C 001D0E0C  D3 C3 00 28 */	stfs f30, 0x28(r3)
/* 801D3E10 001D0E10  C3 C2 E4 B4 */	lfs f30, lbl_8041F834@sda21(r2)
/* 801D3E14 001D0E14  90 E3 00 18 */	stw r7, 0x18(r3)
/* 801D3E18 001D0E18  C3 E2 E4 BC */	lfs f31, lbl_8041F83C@sda21(r2)
...
/* 801D3E78 001D0E78  41 80 FF AC */	blt .L_801D3E24
