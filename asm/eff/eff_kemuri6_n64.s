...
/* 801C6A1C 001C3A1C  48 00 01 20 */	b .L_801C6B3C
.L_801C6A20:
/* 801C6A20 001C3A20  80 1E 00 00 */	lwz r0, 0(r30)
/* 801C6A24 001C3A24  2C 00 00 00 */	cmpwi r0, 0
/* 801C6A28 001C3A28  41 82 01 0C */	beq .L_801C6B34
...
/* 801C6B44 001C3B44  41 80 FE DC */	blt .L_801C6A20
...
/* 801C6BE4 001C3BE4  48 00 01 5C */	b .L_801C6D40
.L_801C6BE8:
/* 801C6BE8 001C3BE8  80 1F 00 00 */	lwz r0, 0(r31)
/* 801C6BEC 001C3BEC  2C 00 00 00 */	cmpwi r0, 0
/* 801C6BF0 001C3BF0  41 82 01 48 */	beq .L_801C6D38
...
/* 801C6C04 001C3C04  41 81 00 10 */	bgt .L_801C6C14
/* 801C6C08 001C3C08  38 00 00 00 */	li r0, 0
/* 801C6C0C 001C3C0C  90 1F 00 00 */	stw r0, 0(r31)
/* 801C6C10 001C3C10  48 00 01 28 */	b .L_801C6D38
.L_801C6C14:
...
/* 801C6C8C 001C3C8C  40 82 00 38 */	bne .L_801C6CC4
/* 801C6C90 001C3C90  A8 1F 00 06 */	lha r0, 6(r31)
/* 801C6C94 001C3C94  2C 00 00 04 */	cmpwi r0, 4
/* 801C6C98 001C3C98  40 81 00 2C */	ble .L_801C6CC4
/* 801C6C9C 001C3C9C  2C 00 00 05 */	cmpwi r0, 5
/* 801C6CA0 001C3CA0  41 81 00 24 */	bgt .L_801C6CC4
...
/* 801C6CB0 001C3CB0  40 82 00 14 */	bne .L_801C6CC4
...
/* 801C6CC0 001C3CC0  48 00 00 C0 */	b .L_801C6D80
.L_801C6CC4:
...
/* 801C6D2C 001C3D2C  40 80 00 0C */	bge .L_801C6D38
...
/* 801C6D48 001C3D48  41 80 FE A0 */	blt .L_801C6BE8
/* 801C6D4C 001C3D4C  2C 1D 00 00 */	cmpwi r29, 0
/* 801C6D50 001C3D50  40 82 00 10 */	bne .L_801C6D60
/* 801C6D54 001C3D54  7F 83 E3 78 */	mr r3, r28
/* 801C6D58 001C3D58  4B E9 6E 2D */	bl effDelete
/* 801C6D5C 001C3D5C  48 00 00 24 */	b .L_801C6D80
.L_801C6D60:
