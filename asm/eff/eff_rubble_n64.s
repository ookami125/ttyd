...
/* 801DFA80 001DCA80  C0 22 E8 B4 */	lfs f1, lbl_8041FC34@sda21(r2)
...
/* 801DFAA8 001DCAA8  C0 22 E8 B4 */	lfs f1, lbl_8041FC34@sda21(r2)
...
/* 801DFAD0 001DCAD0  C0 22 E8 B4 */	lfs f1, lbl_8041FC34@sda21(r2)
...
/* 801DFB40 001DCB40  80 02 E8 B0 */	lwz r0, lbl_8041FC30@sda21(r2)
...
/* 801DFC24 001DCC24  41 82 00 30 */	beq .L_801DFC54
/* 801DFC28 001DCC28  40 80 00 1C */	bge .L_801DFC44
/* 801DFC2C 001DCC2C  2C 00 00 01 */	cmpwi r0, 1
/* 801DFC30 001DCC30  41 82 00 FC */	beq .L_801DFD2C
/* 801DFC34 001DCC34  40 80 01 88 */	bge .L_801DFDBC
/* 801DFC38 001DCC38  2C 00 00 00 */	cmpwi r0, 0
/* 801DFC3C 001DCC3C  40 80 00 18 */	bge .L_801DFC54
/* 801DFC40 001DCC40  48 00 02 4C */	b .L_801DFE8C
.L_801DFC44:
/* 801DFC44 001DCC44  2C 00 00 05 */	cmpwi r0, 5
/* 801DFC48 001DCC48  41 82 01 74 */	beq .L_801DFDBC
/* 801DFC4C 001DCC4C  40 80 02 40 */	bge .L_801DFE8C
/* 801DFC50 001DCC50  48 00 00 DC */	b .L_801DFD2C
.L_801DFC54:
...
/* 801DFD28 001DCD28  48 00 01 64 */	b .L_801DFE8C
.L_801DFD2C:
...
/* 801DFDB8 001DCDB8  48 00 00 D4 */	b .L_801DFE8C
.L_801DFDBC:
...
/* 801DFF38 001DCF38  40 80 00 0C */	bge .L_801DFF44
/* 801DFF3C 001DCF3C  4B E7 DC 49 */	bl effDelete
/* 801DFF40 001DCF40  48 00 01 00 */	b .L_801E0040
.L_801DFF44:
...
/* 801DFF50 001DCF50  41 82 00 8C */	beq .L_801DFFDC
...
/* 801DFFB4 001DCFB4  40 82 00 28 */	bne .L_801DFFDC
...
/* 801DFFE0 001DCFE0  40 80 00 40 */	bge .L_801E0020
...
/* 801E0000 001DD000  C0 02 E8 B8 */	lfs f0, lbl_8041FC38@sda21(r2)
...
/* 801E0110 001DD110  C0 02 E8 BC */	lfs f0, lbl_8041FC3C@sda21(r2)
...
/* 801E01A4 001DD1A4  C0 02 E8 C8 */	lfs f0, lbl_8041FC48@sda21(r2)
...
/* 801E01B4 001DD1B4  C0 62 E8 BC */	lfs f3, lbl_8041FC3C@sda21(r2)
...
/* 801E01C4 001DD1C4  C0 42 E8 C0 */	lfs f2, lbl_8041FC40@sda21(r2)
/* 801E01C8 001DD1C8  7C 00 46 70 */	srawi r0, r0, 8
/* 801E01CC 001DD1CC  C0 22 E8 C4 */	lfs f1, lbl_8041FC44@sda21(r2)
