...
/* 801AF658 001AC658  41 80 01 08 */	blt .L_801AF760
...
/* 801AF75C 001AC75C  48 00 01 04 */	b .L_801AF860
.L_801AF760:
...
/* 801AF884 001AC884  C0 22 D8 18 */	lfs f1, lbl_8041EB98@sda21(r2)
/* 801AF888 001AC888  38 61 00 38 */	addi r3, r1, 0x38
/* 801AF88C 001AC88C  C0 42 D8 1C */	lfs f2, lbl_8041EB9C@sda21(r2)
/* 801AF890 001AC890  C0 62 D8 20 */	lfs f3, lbl_8041EBA0@sda21(r2)
...
/* 801AF8C0 001AC8C0  80 02 1D 40 */	lwz r0, lbl_804230C0@sda21(r2)
...
/* 801AF8F8 001AC8F8  80 02 1D 44 */	lwz r0, lbl_804230C4@sda21(r2)
...
/* 801AF9C8 001AC9C8  41 82 00 08 */	beq .L_801AF9D0
...
/* 801AFA0C 001ACA0C  41 82 00 08 */	beq .L_801AFA14
...
/* 801AFA50 001ACA50  41 82 00 08 */	beq .L_801AFA58
/* 801AFA54 001ACA54  38 63 00 01 */	addi r3, r3, 1
.L_801AFA58:
/* 801AFA58 001ACA58  38 E7 00 01 */	addi r7, r7, 1
/* 801AFA5C 001ACA5C  42 00 FF 34 */	bdnz .L_801AF990
/* 801AFA60 001ACA60  34 03 FF FF */	addic. r0, r3, -1
/* 801AFA64 001ACA64  40 81 04 60 */	ble .L_801AFEC4
...
/* 801AFA74 001ACA74  C3 82 D8 24 */	lfs f28, lbl_8041EBA4@sda21(r2)
/* 801AFA78 001ACA78  CB A4 A3 E8 */	lfd f29, lbl_802FA3E8@l(r4)
/* 801AFA7C 001ACA7C  7E BC AB 78 */	mr r28, r21
/* 801AFA80 001ACA80  C3 C2 D8 28 */	lfs f30, lbl_8041EBA8@sda21(r2)
/* 801AFA84 001ACA84  7F 3B CB 78 */	mr r27, r25
/* 801AFA88 001ACA88  C3 E2 D8 2C */	lfs f31, lbl_8041EBAC@sda21(r2)
...
/* 801AFAFC 001ACAFC  40 81 00 08 */	ble .L_801AFB04
...
/* 801AFB14 001ACB14  41 82 03 40 */	beq .L_801AFE54
/* 801AFB18 001ACB18  2C 14 FF FF */	cmpwi r20, -1
/* 801AFB1C 001ACB1C  40 82 00 44 */	bne .L_801AFB60
/* 801AFB20 001ACB20  38 0F 00 01 */	addi r0, r15, 1
/* 801AFB24 001ACB24  2C 00 00 1E */	cmpwi r0, 0x1e
/* 801AFB28 001ACB28  41 80 00 08 */	blt .L_801AFB30
...
/* 801AFB5C 001ACB5C  48 00 00 B8 */	b .L_801AFC14
.L_801AFB60:
/* 801AFB60 001ACB60  2C 19 00 1D */	cmpwi r25, 0x1d
/* 801AFB64 001ACB64  41 82 00 B0 */	beq .L_801AFC14
...
/* 801AFB74 001ACB74  41 80 00 08 */	blt .L_801AFB7C
/* 801AFB78 001ACB78  38 00 00 00 */	li r0, 0
.L_801AFB7C:
/* 801AFB7C 001ACB7C  2C 11 00 00 */	cmpwi r17, 0
/* 801AFB80 001ACB80  40 80 00 08 */	bge .L_801AFB88
...
/* 801AFBD8 001ACBD8  C0 02 D8 30 */	lfs f0, lbl_8041EBB0@sda21(r2)
/* 801AFBDC 001ACBDC  EC 22 A8 28 */	fsubs f1, f2, f21
/* 801AFBE0 001ACBE0  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 801AFBE4 001ACBE4  40 81 00 10 */	ble .L_801AFBF4
/* 801AFBE8 001ACBE8  C0 02 D8 28 */	lfs f0, lbl_8041EBA8@sda21(r2)
/* 801AFBEC 001ACBEC  EE B5 00 2A */	fadds f21, f21, f0
/* 801AFBF0 001ACBF0  48 00 00 18 */	b .L_801AFC08
.L_801AFBF4:
/* 801AFBF4 001ACBF4  C0 02 D8 34 */	lfs f0, lbl_8041EBB4@sda21(r2)
/* 801AFBF8 001ACBF8  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 801AFBFC 001ACBFC  40 80 00 0C */	bge .L_801AFC08
/* 801AFC00 001ACC00  C0 02 D8 28 */	lfs f0, lbl_8041EBA8@sda21(r2)
/* 801AFC04 001ACC04  EC 42 00 2A */	fadds f2, f2, f0
.L_801AFC08:
/* 801AFC08 001ACC08  EF 55 10 2A */	fadds f26, f21, f2
/* 801AFC0C 001ACC0C  C0 02 D8 38 */	lfs f0, lbl_8041EBB8@sda21(r2)
...
/* 801AFC2C 001ACC2C  C0 62 D8 24 */	lfs f3, lbl_8041EBA4@sda21(r2)
/* 801AFC30 001ACC30  7E 04 B8 50 */	subf r16, r4, r23
/* 801AFC34 001ACC34  C0 02 D8 28 */	lfs f0, lbl_8041EBA8@sda21(r2)
...
/* 801AFC88 001ACC88  C0 22 D8 40 */	lfs f1, lbl_8041EBC0@sda21(r2)
/* 801AFC8C 001ACC8C  C8 41 00 68 */	lfd f2, 0x68(r1)
/* 801AFC90 001ACC90  C0 02 D8 3C */	lfs f0, lbl_8041EBBC@sda21(r2)
...
/* 801AFCA4 001ACCA4  40 82 00 24 */	bne .L_801AFCC8
/* 801AFCA8 001ACCA8  C0 22 D8 44 */	lfs f1, lbl_8041EBC4@sda21(r2)
...
/* 801AFCC4 001ACCC4  48 00 00 20 */	b .L_801AFCE4
.L_801AFCC8:
/* 801AFCC8 001ACCC8  C0 22 D8 44 */	lfs f1, lbl_8041EBC4@sda21(r2)
...
/* 801AFCF8 001ACCF8  40 80 00 7C */	bge .L_801AFD74
...
/* 801AFD18 001ACD18  C0 22 D8 48 */	lfs f1, lbl_8041EBC8@sda21(r2)
...
/* 801AFD38 001ACD38  40 80 00 3C */	bge .L_801AFD74
/* 801AFD3C 001ACD3C  6F 40 80 00 */	xoris r0, r26, 0x8000
/* 801AFD40 001ACD40  90 81 00 80 */	stw r4, 0x80(r1)
/* 801AFD44 001ACD44  C0 22 D8 4C */	lfs f1, lbl_8041EBCC@sda21(r2)
...
/* 801AFD6C 001ACD6C  40 80 00 08 */	bge .L_801AFD74
/* 801AFD70 001ACD70  3A 00 00 00 */	li r16, 0
.L_801AFD74:
/* 801AFD74 001ACD74  C0 22 D8 24 */	lfs f1, lbl_8041EBA4@sda21(r2)
/* 801AFD78 001ACD78  C0 02 D8 28 */	lfs f0, lbl_8041EBA8@sda21(r2)
...
/* 801AFDA0 001ACDA0  C0 02 D8 20 */	lfs f0, lbl_8041EBA0@sda21(r2)
...
/* 801AFE60 001ACE60  41 80 FC 38 */	blt .L_801AFA98
...
/* 801AFE7C 001ACE7C  48 00 00 40 */	b .L_801AFEBC
.L_801AFE80:
...
/* 801AFEC0 001ACEC0  41 80 FF C0 */	blt .L_801AFE80
.L_801AFEC4:
...
/* 801AFFB0 001ACFB0  41 82 00 14 */	beq .L_801AFFC4
...
/* 801AFFCC 001ACFCC  40 80 00 0C */	bge .L_801AFFD8
...
/* 801B0014 001AD014  40 82 00 D4 */	bne .L_801B00E8
...
/* 801B0134 001AD134  40 82 00 14 */	bne .L_801B0148
/* 801B0138 001AD138  FC 04 08 00 */	fcmpu cr0, f4, f1
/* 801B013C 001AD13C  40 82 00 0C */	bne .L_801B0148
/* 801B0140 001AD140  FC 05 10 00 */	fcmpu cr0, f5, f2
/* 801B0144 001AD144  41 82 01 5C */	beq .L_801B02A0
.L_801B0148:
...
/* 801B0164 001AD164  41 80 00 0C */	blt .L_801B0170
...
/* 801B0194 001AD194  C0 02 D8 20 */	lfs f0, lbl_8041EBA0@sda21(r2)
...
/* 801B01B4 001AD1B4  41 82 00 E0 */	beq .L_801B0294
/* 801B01B8 001AD1B8  FC 04 00 40 */	fcmpo cr0, f4, f0
/* 801B01BC 001AD1BC  40 81 00 4C */	ble .L_801B0208
...
/* 801B0234 001AD234  41 82 00 14 */	beq .L_801B0248
/* 801B0238 001AD238  40 80 00 3C */	bge .L_801B0274
/* 801B023C 001AD23C  2C 03 00 00 */	cmpwi r3, 0
/* 801B0240 001AD240  41 82 00 1C */	beq .L_801B025C
/* 801B0244 001AD244  48 00 00 30 */	b .L_801B0274
.L_801B0248:
/* 801B0248 001AD248  54 C0 02 7F */	clrlwi. r0, r6, 9
/* 801B024C 001AD24C  41 82 00 08 */	beq .L_801B0254
/* 801B0250 001AD250  48 00 00 28 */	b .L_801B0278
.L_801B0254:
/* 801B0254 001AD254  38 80 00 02 */	li r4, 2
/* 801B0258 001AD258  48 00 00 20 */	b .L_801B0278
.L_801B025C:
/* 801B025C 001AD25C  54 C0 02 7F */	clrlwi. r0, r6, 9
/* 801B0260 001AD260  41 82 00 0C */	beq .L_801B026C
/* 801B0264 001AD264  38 80 00 05 */	li r4, 5
/* 801B0268 001AD268  48 00 00 10 */	b .L_801B0278
.L_801B026C:
/* 801B026C 001AD26C  38 80 00 03 */	li r4, 3
/* 801B0270 001AD270  48 00 00 08 */	b .L_801B0278
.L_801B0274:
/* 801B0274 001AD274  38 80 00 04 */	li r4, 4
.L_801B0278:
/* 801B0278 001AD278  2C 04 00 01 */	cmpwi r4, 1
/* 801B027C 001AD27C  40 82 00 10 */	bne .L_801B028C
/* 801B0280 001AD280  3C 60 80 42 */	lis r3, lbl_804181A8@ha
/* 801B0284 001AD284  C0 03 81 A8 */	lfs f0, lbl_804181A8@l(r3)
/* 801B0288 001AD288  48 00 00 08 */	b .L_801B0290
.L_801B028C:
...
/* 801B038C 001AD38C  41 81 00 10 */	bgt .L_801B039C
/* 801B0390 001AD390  38 00 03 E8 */	li r0, 0x3e8
/* 801B0394 001AD394  90 1F 00 10 */	stw r0, 0x10(r31)
/* 801B0398 001AD398  48 00 00 08 */	b .L_801B03A0
.L_801B039C:
...
/* 801B03B4 001AD3B4  41 82 00 84 */	beq .L_801B0438
/* 801B03B8 001AD3B8  40 80 00 14 */	bge .L_801B03CC
/* 801B03BC 001AD3BC  2C 1C 00 00 */	cmpwi r28, 0
/* 801B03C0 001AD3C0  41 82 00 18 */	beq .L_801B03D8
/* 801B03C4 001AD3C4  40 80 00 3C */	bge .L_801B0400
/* 801B03C8 001AD3C8  48 00 00 C8 */	b .L_801B0490
.L_801B03CC:
/* 801B03CC 001AD3CC  2C 1C 00 04 */	cmpwi r28, 4
/* 801B03D0 001AD3D0  40 80 00 C0 */	bge .L_801B0490
/* 801B03D4 001AD3D4  48 00 00 94 */	b .L_801B0468
.L_801B03D8:
...
/* 801B03FC 001AD3FC  48 00 00 94 */	b .L_801B0490
.L_801B0400:
...
/* 801B0434 001AD434  48 00 00 5C */	b .L_801B0490
.L_801B0438:
...
/* 801B0464 001AD464  48 00 00 2C */	b .L_801B0490
.L_801B0468:
...
/* 801B049C 001AD49C  C0 02 D8 20 */	lfs f0, lbl_8041EBA0@sda21(r2)
...
/* 801B055C 001AD55C  C0 02 D8 20 */	lfs f0, lbl_8041EBA0@sda21(r2)
