...
/* 801AA590 001A7590  41 82 00 AC */	beq .L_801AA63C
...
/* 801AA728 001A7728  41 82 00 3C */	beq .L_801AA764
/* 801AA72C 001A772C  40 80 00 10 */	bge .L_801AA73C
/* 801AA730 001A7730  2C 00 00 00 */	cmpwi r0, 0
/* 801AA734 001A7734  40 80 00 14 */	bge .L_801AA748
/* 801AA738 001A7738  48 00 00 60 */	b .L_801AA798
.L_801AA73C:
/* 801AA73C 001A773C  2C 00 00 03 */	cmpwi r0, 3
/* 801AA740 001A7740  40 80 00 58 */	bge .L_801AA798
/* 801AA744 001A7744  48 00 00 3C */	b .L_801AA780
.L_801AA748:
...
/* 801AA760 001A7760  48 00 00 38 */	b .L_801AA798
.L_801AA764:
...
/* 801AA77C 001A777C  48 00 00 1C */	b .L_801AA798
.L_801AA780:
...
/* 801AA868 001A7868  40 80 00 0C */	bge .L_801AA874
/* 801AA86C 001A786C  4B EB 33 19 */	bl effDelete
/* 801AA870 001A7870  48 00 02 28 */	b .L_801AAA98
.L_801AA874:
...
/* 801AA88C 001A788C  40 82 00 50 */	bne .L_801AA8DC
/* 801AA890 001A7890  80 1F 00 3C */	lwz r0, 0x3c(r31)
/* 801AA894 001A7894  2C 00 00 00 */	cmpwi r0, 0
/* 801AA898 001A7898  40 82 00 24 */	bne .L_801AA8BC
...
/* 801AA8B8 001A78B8  48 00 00 50 */	b .L_801AA908
.L_801AA8BC:
...
/* 801AA8D8 001A78D8  48 00 00 30 */	b .L_801AA908
.L_801AA8DC:
/* 801AA8DC 001A78DC  2C 1E 00 01 */	cmpwi r30, 1
/* 801AA8E0 001A78E0  40 82 00 28 */	bne .L_801AA908
...
/* 801AA91C 001A791C  40 80 00 6C */	bge .L_801AA988
/* 801AA920 001A7920  2C 1B 00 02 */	cmpwi r27, 2
/* 801AA924 001A7924  40 82 00 0C */	bne .L_801AA930
/* 801AA928 001A7928  C0 22 D6 64 */	lfs f1, lbl_8041E9E4@sda21(r2)
/* 801AA92C 001A792C  48 00 00 08 */	b .L_801AA934
.L_801AA930:
...
/* 801AA984 001A7984  48 00 00 50 */	b .L_801AA9D4
.L_801AA988:
...
/* 801AA9D8 001A79D8  41 80 00 20 */	blt .L_801AA9F8
/* 801AA9DC 001A79DC  40 82 00 0C */	bne .L_801AA9E8
...
/* 801AA9FC 001A79FC  41 80 00 6C */	blt .L_801AAA68
/* 801AAA00 001A7A00  2C 1E 00 06 */	cmpwi r30, 6
/* 801AAA04 001A7A04  40 80 00 18 */	bge .L_801AAA1C
...
/* 801AAA18 001A7A18  48 00 00 50 */	b .L_801AAA68
.L_801AAA1C:
...
/* 801AAAFC 001A7AFC  41 80 00 0C */	blt .L_801AAB08
...
/* 801AAB6C 001A7B6C  41 82 00 08 */	beq .L_801AAB74
...
/* 801AAB84 001A7B84  40 82 00 0C */	bne .L_801AAB90
/* 801AAB88 001A7B88  C0 02 D6 64 */	lfs f0, lbl_8041E9E4@sda21(r2)
/* 801AAB8C 001A7B8C  48 00 00 08 */	b .L_801AAB94
.L_801AAB90:
...
/* 801AAB9C 001A7B9C  40 82 00 0C */	bne .L_801AABA8
/* 801AABA0 001A7BA0  C0 02 D6 64 */	lfs f0, lbl_8041E9E4@sda21(r2)
/* 801AABA4 001A7BA4  48 00 00 08 */	b .L_801AABAC
.L_801AABA8:
...
/* 801AABC0 001A7BC0  41 82 00 34 */	beq .L_801AABF4
/* 801AABC4 001A7BC4  40 80 00 10 */	bge .L_801AABD4
/* 801AABC8 001A7BC8  2C 1D 00 00 */	cmpwi r29, 0
/* 801AABCC 001A7BCC  40 80 00 14 */	bge .L_801AABE0
/* 801AABD0 001A7BD0  48 00 00 48 */	b .L_801AAC18
.L_801AABD4:
/* 801AABD4 001A7BD4  2C 1D 00 03 */	cmpwi r29, 3
/* 801AABD8 001A7BD8  40 80 00 40 */	bge .L_801AAC18
/* 801AABDC 001A7BDC  48 00 00 2C */	b .L_801AAC08
.L_801AABE0:
...
/* 801AABF0 001A7BF0  48 00 00 28 */	b .L_801AAC18
.L_801AABF4:
...
/* 801AAC04 001A7C04  48 00 00 14 */	b .L_801AAC18
.L_801AAC08:
