...
countDownFlagOff:
/* 801FC2C0 001F92C0  80 8D 18 C8 */	lwz r4, lbl_80418B28@sda21(r13)
...
countDownFlagOn:
/* 801FC2D4 001F92D4  80 8D 18 C8 */	lwz r4, lbl_80418B28@sda21(r13)
...
/* 801FC2F4 001F92F4  80 6D 18 C8 */	lwz r3, lbl_80418B28@sda21(r13)
...
/* 801FC304 001F9304  80 6D 18 C8 */	lwz r3, lbl_80418B28@sda21(r13)
...
.global countDownEnd
countDownEnd:
/* 801FC320 001F9320  80 6D 18 C8 */	lwz r3, lbl_80418B28@sda21(r13)
...
countDownGetStatus:
/* 801FC33C 001F933C  80 6D 18 C8 */	lwz r3, lbl_80418B28@sda21(r13)
/* 801FC340 001F9340  A0 63 00 00 */	lhz r3, 0(r3)
/* 801FC344 001F9344  54 60 07 FF */	clrlwi. r0, r3, 0x1f
/* 801FC348 001F9348  40 82 00 0C */	bne .L_801FC354
...
/* 801FC378 001F9378  80 E2 F1 18 */	lwz r7, lbl_80420498@sda21(r2)
/* 801FC37C 001F937C  80 03 00 F8 */	lwz r0, 0x800000F8@l(r3)
/* 801FC380 001F9380  3C 60 10 62 */	lis r3, 0x10624DD3@ha
/* 801FC384 001F9384  83 CD 18 C8 */	lwz r30, lbl_80418B28@sda21(r13)
...
/* 801FC3D0 001F93D0  40 82 02 BC */	bne .L_801FC68C
/* 801FC3D4 001F93D4  54 E0 07 BD */	rlwinm. r0, r7, 0, 0x1e, 0x1e
/* 801FC3D8 001F93D8  41 82 00 08 */	beq .L_801FC3E0
...
/* 801FC400 001F9400  C0 62 F1 20 */	lfs f3, lbl_804204A0@sda21(r2)
...
/* 801FC430 001F9430  C0 42 F1 28 */	lfs f2, lbl_804204A8@sda21(r2)
/* 801FC434 001F9434  38 61 00 60 */	addi r3, r1, 0x60
/* 801FC438 001F9438  C0 22 F1 24 */	lfs f1, lbl_804204A4@sda21(r2)
...
/* 801FC454 001F9454  80 02 F1 1C */	lwz r0, lbl_8042049C@sda21(r2)
...
/* 801FC4FC 001F94FC  C0 42 F1 2C */	lfs f2, lbl_804204AC@sda21(r2)
/* 801FC500 001F9500  38 61 00 90 */	addi r3, r1, 0x90
/* 801FC504 001F9504  90 01 00 C4 */	stw r0, 0xc4(r1)
/* 801FC508 001F9508  C0 62 F1 20 */	lfs f3, lbl_804204A0@sda21(r2)
...
/* 801FC558 001F9558  41 80 FF 9C */	blt .L_801FC4F4
/* 801FC55C 001F955C  C0 22 F1 30 */	lfs f1, lbl_804204B0@sda21(r2)
/* 801FC560 001F9560  38 61 00 90 */	addi r3, r1, 0x90
/* 801FC564 001F9564  C0 42 F1 34 */	lfs f2, lbl_804204B4@sda21(r2)
/* 801FC568 001F9568  C0 62 F1 20 */	lfs f3, lbl_804204A0@sda21(r2)
...
/* 801FC608 001F9608  C0 42 F1 2C */	lfs f2, lbl_804204AC@sda21(r2)
/* 801FC60C 001F960C  38 61 00 90 */	addi r3, r1, 0x90
/* 801FC610 001F9610  90 01 00 C4 */	stw r0, 0xc4(r1)
/* 801FC614 001F9614  C0 62 F1 20 */	lfs f3, lbl_804204A0@sda21(r2)
...
/* 801FC624 001F9624  C0 22 F1 38 */	lfs f1, lbl_804204B8@sda21(r2)
...
/* 801FC688 001F9688  41 80 FF 78 */	blt .L_801FC600
.L_801FC68C:
...
/* 801FC6B8 001F96B8  80 8D 18 C8 */	lwz r4, lbl_80418B28@sda21(r13)
/* 801FC6BC 001F96BC  A0 64 00 00 */	lhz r3, 0(r4)
/* 801FC6C0 001F96C0  54 60 07 FF */	clrlwi. r0, r3, 0x1f
/* 801FC6C4 001F96C4  41 82 01 FC */	beq .L_801FC8C0
/* 801FC6C8 001F96C8  80 04 00 30 */	lwz r0, 0x30(r4)
/* 801FC6CC 001F96CC  2C 00 00 01 */	cmpwi r0, 1
/* 801FC6D0 001F96D0  41 82 00 7C */	beq .L_801FC74C
/* 801FC6D4 001F96D4  40 80 00 10 */	bge .L_801FC6E4
/* 801FC6D8 001F96D8  2C 00 00 00 */	cmpwi r0, 0
/* 801FC6DC 001F96DC  40 80 00 14 */	bge .L_801FC6F0
/* 801FC6E0 001F96E0  48 00 01 00 */	b .L_801FC7E0
.L_801FC6E4:
/* 801FC6E4 001F96E4  2C 00 00 03 */	cmpwi r0, 3
/* 801FC6E8 001F96E8  40 80 00 F8 */	bge .L_801FC7E0
/* 801FC6EC 001F96EC  48 00 00 80 */	b .L_801FC76C
.L_801FC6F0:
...
/* 801FC700 001F9700  40 80 00 2C */	bge .L_801FC72C
/* 801FC704 001F9704  80 8D 18 C8 */	lwz r4, lbl_80418B28@sda21(r13)
/* 801FC708 001F9708  38 60 00 0B */	li r3, 0xb
/* 801FC70C 001F970C  C0 22 F1 3C */	lfs f1, lbl_804204BC@sda21(r2)
/* 801FC710 001F9710  38 A0 00 1E */	li r5, 0x1e
/* 801FC714 001F9714  C0 42 F1 20 */	lfs f2, lbl_804204A0@sda21(r2)
/* 801FC718 001F9718  80 84 00 34 */	lwz r4, 0x34(r4)
/* 801FC71C 001F971C  4B E0 A4 F1 */	bl intplGetValue
/* 801FC720 001F9720  80 6D 18 C8 */	lwz r3, lbl_80418B28@sda21(r13)
/* 801FC724 001F9724  D0 23 00 28 */	stfs f1, 0x28(r3)
/* 801FC728 001F9728  48 00 00 B8 */	b .L_801FC7E0
.L_801FC72C:
/* 801FC72C 001F972C  80 6D 18 C8 */	lwz r3, lbl_80418B28@sda21(r13)
/* 801FC730 001F9730  38 00 00 00 */	li r0, 0
/* 801FC734 001F9734  90 03 00 34 */	stw r0, 0x34(r3)
/* 801FC738 001F9738  80 8D 18 C8 */	lwz r4, lbl_80418B28@sda21(r13)
...
/* 801FC77C 001F977C  40 80 00 2C */	bge .L_801FC7A8
/* 801FC780 001F9780  80 8D 18 C8 */	lwz r4, lbl_80418B28@sda21(r13)
/* 801FC784 001F9784  38 60 00 0B */	li r3, 0xb
/* 801FC788 001F9788  C0 22 F1 20 */	lfs f1, lbl_804204A0@sda21(r2)
/* 801FC78C 001F978C  38 A0 00 1E */	li r5, 0x1e
/* 801FC790 001F9790  C0 42 F1 3C */	lfs f2, lbl_804204BC@sda21(r2)
/* 801FC794 001F9794  80 84 00 34 */	lwz r4, 0x34(r4)
/* 801FC798 001F9798  4B E0 A4 75 */	bl intplGetValue
/* 801FC79C 001F979C  80 6D 18 C8 */	lwz r3, lbl_80418B28@sda21(r13)
/* 801FC7A0 001F97A0  D0 23 00 28 */	stfs f1, 0x28(r3)
/* 801FC7A4 001F97A4  48 00 00 3C */	b .L_801FC7E0
.L_801FC7A8:
/* 801FC7A8 001F97A8  80 6D 18 C8 */	lwz r3, lbl_80418B28@sda21(r13)
/* 801FC7AC 001F97AC  38 00 00 00 */	li r0, 0
/* 801FC7B0 001F97B0  90 03 00 34 */	stw r0, 0x34(r3)
/* 801FC7B4 001F97B4  80 8D 18 C8 */	lwz r4, lbl_80418B28@sda21(r13)
...
/* 801FC7C4 001F97C4  80 6D 18 C8 */	lwz r3, lbl_80418B28@sda21(r13)
...
/* 801FC7D4 001F97D4  80 6D 18 C8 */	lwz r3, lbl_80418B28@sda21(r13)
/* 801FC7D8 001F97D8  80 63 00 38 */	lwz r3, 0x38(r3)
/* 801FC7DC 001F97DC  4B ED 8A 21 */	bl psndSFXOff
.L_801FC7E0:
/* 801FC7E0 001F97E0  80 6D 18 C8 */	lwz r3, lbl_80418B28@sda21(r13)
/* 801FC7E4 001F97E4  A0 03 00 00 */	lhz r0, 0(r3)
/* 801FC7E8 001F97E8  54 00 07 39 */	rlwinm. r0, r0, 0, 0x1c, 0x1c
/* 801FC7EC 001F97EC  40 82 00 40 */	bne .L_801FC82C
/* 801FC7F0 001F97F0  4B E7 1D 5D */	bl marioStGetSystemLevel
/* 801FC7F4 001F97F4  28 03 00 00 */	cmplwi r3, 0
/* 801FC7F8 001F97F8  40 82 00 34 */	bne .L_801FC82C
/* 801FC7FC 001F97FC  80 CD 18 C8 */	lwz r6, lbl_80418B28@sda21(r13)
/* 801FC800 001F9800  80 6D 90 B0 */	lwz r3, gp@sda21(r13)
...
.L_801FC82C:
/* 801FC82C 001F982C  80 AD 90 B0 */	lwz r5, gp@sda21(r13)
/* 801FC830 001F9830  3C 60 10 62 */	lis r3, 0x10624DD3@ha
/* 801FC834 001F9834  80 CD 18 C8 */	lwz r6, lbl_80418B28@sda21(r13)
...
/* 801FC858 001F9858  83 ED 18 C8 */	lwz r31, lbl_80418B28@sda21(r13)
...
/* 801FC894 001F9894  40 82 00 10 */	bne .L_801FC8A4
...
/* 801FC8A8 001F98A8  C0 22 F1 40 */	lfs f1, lbl_804204C0@sda21(r2)
...
/* 801FC8D4 001F98D4  80 8D 18 C8 */	lwz r4, lbl_80418B28@sda21(r13)
...
/* 801FC8EC 001F98EC  C0 42 F1 20 */	lfs f2, lbl_804204A0@sda21(r2)
/* 801FC8F0 001F98F0  90 01 00 14 */	stw r0, 0x14(r1)
/* 801FC8F4 001F98F4  38 00 00 00 */	li r0, 0
/* 801FC8F8 001F98F8  C0 22 F1 44 */	lfs f1, lbl_804204C4@sda21(r2)
/* 801FC8FC 001F98FC  80 CD 18 C8 */	lwz r6, lbl_80418B28@sda21(r13)
/* 801FC900 001F9900  C0 02 F1 48 */	lfs f0, lbl_804204C8@sda21(r2)
/* 801FC904 001F9904  90 66 00 18 */	stw r3, 0x18(r6)
/* 801FC908 001F9908  38 60 00 00 */	li r3, 0
/* 801FC90C 001F990C  80 CD 18 C8 */	lwz r6, lbl_80418B28@sda21(r13)
/* 801FC910 001F9910  90 86 00 1C */	stw r4, 0x1c(r6)
/* 801FC914 001F9914  38 85 01 80 */	addi r4, r5, 0xF5DE0180@l
/* 801FC918 001F9918  80 ED 90 B0 */	lwz r7, gp@sda21(r13)
/* 801FC91C 001F991C  80 AD 18 C8 */	lwz r5, lbl_80418B28@sda21(r13)
...
/* 801FC930 001F9930  80 AD 18 C8 */	lwz r5, lbl_80418B28@sda21(r13)
/* 801FC934 001F9934  90 05 00 0C */	stw r0, 0xc(r5)
/* 801FC938 001F9938  90 05 00 08 */	stw r0, 8(r5)
/* 801FC93C 001F993C  80 AD 18 C8 */	lwz r5, lbl_80418B28@sda21(r13)
/* 801FC940 001F9940  90 05 00 30 */	stw r0, 0x30(r5)
/* 801FC944 001F9944  80 AD 18 C8 */	lwz r5, lbl_80418B28@sda21(r13)
/* 801FC948 001F9948  90 05 00 34 */	stw r0, 0x34(r5)
/* 801FC94C 001F994C  80 AD 18 C8 */	lwz r5, lbl_80418B28@sda21(r13)
/* 801FC950 001F9950  D0 45 00 28 */	stfs f2, 0x28(r5)
/* 801FC954 001F9954  80 AD 18 C8 */	lwz r5, lbl_80418B28@sda21(r13)
/* 801FC958 001F9958  D0 45 00 2C */	stfs f2, 0x2c(r5)
/* 801FC95C 001F995C  80 AD 18 C8 */	lwz r5, lbl_80418B28@sda21(r13)
/* 801FC960 001F9960  D0 25 00 20 */	stfs f1, 0x20(r5)
/* 801FC964 001F9964  80 AD 18 C8 */	lwz r5, lbl_80418B28@sda21(r13)
/* 801FC968 001F9968  D0 05 00 24 */	stfs f0, 0x24(r5)
/* 801FC96C 001F996C  80 AD 18 C8 */	lwz r5, lbl_80418B28@sda21(r13)
/* 801FC970 001F9970  B0 05 00 00 */	sth r0, 0(r5)
/* 801FC974 001F9974  80 AD 18 C8 */	lwz r5, lbl_80418B28@sda21(r13)
...
/* 801FC98C 001F998C  40 80 00 1C */	bge .L_801FC9A8
...
/* 801FC99C 001F999C  80 8D 18 C8 */	lwz r4, lbl_80418B28@sda21(r13)
/* 801FC9A0 001F99A0  90 64 00 38 */	stw r3, 0x38(r4)
/* 801FC9A4 001F99A4  48 00 00 18 */	b .L_801FC9BC
.L_801FC9A8:
...
/* 801FC9B4 001F99B4  80 8D 18 C8 */	lwz r4, lbl_80418B28@sda21(r13)
...
/* 801FC9E4 001F99E4  83 ED 18 C8 */	lwz r31, lbl_80418B28@sda21(r13)
/* 801FC9E8 001F99E8  A0 1F 00 00 */	lhz r0, 0(r31)
/* 801FC9EC 001F99EC  54 00 07 FF */	clrlwi. r0, r0, 0x1f
/* 801FC9F0 001F99F0  41 82 00 D0 */	beq .L_801FCAC0
...
/* 801FCA3C 001F9A3C  41 81 00 28 */	bgt .L_801FCA64
...
.L_801FCA64:
/* 801FCA64 001F9A64  80 CD 90 B0 */	lwz r6, gp@sda21(r13)
/* 801FCA68 001F9A68  3C 60 F5 DE */	lis r3, 0xF5DE0180@ha
/* 801FCA6C 001F9A6C  80 AD 18 C8 */	lwz r5, lbl_80418B28@sda21(r13)
...
/* 801FCA90 001F9A90  40 80 00 1C */	bge .L_801FCAAC
...
/* 801FCAA0 001F9AA0  80 8D 18 C8 */	lwz r4, lbl_80418B28@sda21(r13)
/* 801FCAA4 001F9AA4  90 64 00 38 */	stw r3, 0x38(r4)
/* 801FCAA8 001F9AA8  48 00 00 18 */	b .L_801FCAC0
.L_801FCAAC:
...
/* 801FCAB8 001F9AB8  80 8D 18 C8 */	lwz r4, lbl_80418B28@sda21(r13)
...
/* 801FCAF0 001F9AF0  80 6D 90 B0 */	lwz r3, gp@sda21(r13)
/* 801FCAF4 001F9AF4  38 63 00 68 */	addi r3, r3, 0x68
/* 801FCAF8 001F9AF8  90 6D 18 C8 */	stw r3, lbl_80418B28@sda21(r13)
