...
/* 800EC44C 000E944C  41 82 00 10 */	beq .L_800EC45C
/* 800EC450 000E9450  A0 03 00 00 */	lhz r0, 0(r3)
/* 800EC454 000E9454  54 00 07 FF */	clrlwi. r0, r0, 0x1f
/* 800EC458 000E9458  40 82 00 3C */	bne .L_800EC494
.L_800EC45C:
...
/* 800EC46C 000E946C  41 82 00 28 */	beq .L_800EC494
...
/* 800EC5E4 000E95E4  41 82 00 24 */	beq .L_800EC608
...
/* 800EC610 000E9610  40 80 00 BC */	bge .L_800EC6CC
...
/* 800EC628 000E9628  40 82 00 50 */	bne .L_800EC678
...
/* 800EC674 000E9674  48 00 00 4C */	b .L_800EC6C0
.L_800EC678:
...
/* 800ECA84 000E9A84  40 80 00 18 */	bge .L_800ECA9C
...
/* 800ECA98 000E9A98  48 00 00 14 */	b .L_800ECAAC
.L_800ECA9C:
...
/* 800ECB08 000E9B08  41 82 00 1C */	beq .L_800ECB24
...
/* 800ECB18 000E9B18  41 82 00 0C */	beq .L_800ECB24
/* 800ECB1C 000E9B1C  3B A0 00 00 */	li r29, 0
/* 800ECB20 000E9B20  48 00 00 7C */	b .L_800ECB9C
.L_800ECB24:
/* 800ECB24 000E9B24  A0 03 00 0E */	lhz r0, 0xe(r3)
/* 800ECB28 000E9B28  54 00 07 FF */	clrlwi. r0, r0, 0x1f
/* 800ECB2C 000E9B2C  41 82 00 1C */	beq .L_800ECB48
...
/* 800ECB3C 000E9B3C  41 82 00 0C */	beq .L_800ECB48
/* 800ECB40 000E9B40  3B A0 00 00 */	li r29, 0
/* 800ECB44 000E9B44  48 00 00 58 */	b .L_800ECB9C
.L_800ECB48:
/* 800ECB48 000E9B48  A0 03 00 1C */	lhz r0, 0x1c(r3)
/* 800ECB4C 000E9B4C  54 00 07 FF */	clrlwi. r0, r0, 0x1f
/* 800ECB50 000E9B50  41 82 00 1C */	beq .L_800ECB6C
...
/* 800ECB60 000E9B60  41 82 00 0C */	beq .L_800ECB6C
/* 800ECB64 000E9B64  3B A0 00 00 */	li r29, 0
/* 800ECB68 000E9B68  48 00 00 34 */	b .L_800ECB9C
.L_800ECB6C:
/* 800ECB6C 000E9B6C  A0 03 00 2A */	lhz r0, 0x2a(r3)
/* 800ECB70 000E9B70  54 00 07 FF */	clrlwi. r0, r0, 0x1f
/* 800ECB74 000E9B74  41 82 00 1C */	beq .L_800ECB90
...
/* 800ECB84 000E9B84  41 82 00 0C */	beq .L_800ECB90
/* 800ECB88 000E9B88  3B A0 00 00 */	li r29, 0
/* 800ECB8C 000E9B8C  48 00 00 10 */	b .L_800ECB9C
.L_800ECB90:
/* 800ECB90 000E9B90  38 63 00 38 */	addi r3, r3, 0x38
/* 800ECB94 000E9B94  38 A5 00 03 */	addi r5, r5, 3
/* 800ECB98 000E9B98  42 00 FF 68 */	bdnz .L_800ECB00
.L_800ECB9C:
...
/* 800ECBAC 000E9BAC  40 82 00 48 */	bne .L_800ECBF4
...
/* 800ECBC0 000E9BC0  40 82 00 34 */	bne .L_800ECBF4
...
/* 800ECBD4 000E9BD4  40 82 00 20 */	bne .L_800ECBF4
/* 800ECBD8 000E9BD8  2C 1D 00 00 */	cmpwi r29, 0
/* 800ECBDC 000E9BDC  41 82 00 18 */	beq .L_800ECBF4
...
/* 800ECBF0 000E9BF0  48 00 00 14 */	b .L_800ECC04
.L_800ECBF4:
...
/* 800ECCD0 000E9CD0  40 82 00 0C */	bne .L_800ECCDC
/* 800ECCD4 000E9CD4  38 60 00 00 */	li r3, 0
/* 800ECCD8 000E9CD8  48 00 00 1C */	b .L_800ECCF4
.L_800ECCDC:
